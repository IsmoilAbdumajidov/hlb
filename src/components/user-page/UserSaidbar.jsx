    ...
    return (
        <div className={`${isOpen ? "-translate-x-48" : "translate-x-none"}   w-60  fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B]`}>
            ...
            <div className={`${isOpen ? "flex" : "hidden"}  mt-20 flex-col space-y-2 w-full h-[calc(100vh)]`}>
                <NavLink to={"kurslar"} className="hover:ml-4 justify-end pr-5 text-white hover:text-[#FCAF3C] w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
                    <HiOutlineAcademicCap />
                </NavLink>
                <NavLink to={"my-kurs"} className="hover:ml-4 justify-end pr-5 text-white hover:text-[#FCAF3C] w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
                ...
                <NavLink to={"statistic"} className="hover:ml-4 justify-end pr-5 text-white hover:text-[#FCAF3C] w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" dataslot="icon" className="w-4 h-4">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z" />
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0 0 13.5 3v7.5Z" />
                    </svg>
