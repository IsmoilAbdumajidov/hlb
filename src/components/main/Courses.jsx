        ...
        <div>
            <div className="main-container">
                ...
                <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 xl:grid-cols-3">
                    <div className=' flex overflow-hidden bg-orange-50 transition-all duration-300 border hover:border-[#ff663b] flex-col group  rounded-2xl'>
                        ...
                        <div className='flex flex-col p-5'>
                            ...
                            <p className='text-slate-700 text-md  mt-5'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam quos debitis molestias, aperiam soluta incidunt dolorem tempore maiores quia ea.</p>
                            <button className='bg py-3 w-full rounded-lg text-white mt-6'>Kirish</button>
                        </div>
                    </div>
                    <div className=' flex overflow-hidden bg-orange-50 transition-all duration-300 border hover:border-[#ff663b] flex-col group  rounded-2xl'>
                        <div className='aspect-[5/3] overflow-hidden'>
